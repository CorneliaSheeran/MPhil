...
title('Network/Topological Complexity Against Small-worldness')
xlabel('Small-worldness')
ylabel('Complexity')
%legend("Spatially Embedded", "L1")
grid on

saveas(figure1, '/home/cs07/sw_90_com_KS_plot.pdf')
...
saveas(figure2, '/home/cs07/sw_90_spatial_KS_plot.pdf')
